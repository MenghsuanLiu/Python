...
class MACD2Strategy(CtaTemplate):
    ...
    def on_15min_bar(self, bar: BarData):
        ...
        self.ema_value = self.am.ema(self.ema_window, array=False)
        ...
        if self.pos == 0:
            ...
            if bar.close_price > self.ema_value and cross_over:
                self.buy(bar.close_price * 1.01, self.fixed_size)

            elif bar.close_price < self.ema_value and cross_below:
